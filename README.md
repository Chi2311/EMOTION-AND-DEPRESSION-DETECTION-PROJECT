# Dự Án Nghiên Cứu và Triển Khai Mô Hình Học Máy Nhận Diện Trạng Thái Cảm Xúc, Tiền Đề Cho Mục Đích Sàng lọc Trầm Cảm Ở Giới Trẻ
...
4.  **`code_fusion/`**: Tầng tích hợp thuật toán **Late Fusion** gộp kết quả từ biểu cảm khuôn mặt, văn bản ngữ cảnh và âm thanh giọng nói để đưa ra chẩn đoán cảm xúc cuối cùng với độ chính xác đạt **91%** trên tập dữ liệu 100 video.
